...
def pie_chart(filename, data, gap=0):
    ...
    gotham_title = ImageFont.truetype("fonts/Gotham-Black.otf", 48)
    ...
    gotham_medium = ImageFont.truetype("fonts/Gotham-Medium.otf", 12)
...
def box_chart(filename, data):
    ...
    gotham_label = ImageFont.truetype("fonts/Gotham-Medium.otf", 12)
